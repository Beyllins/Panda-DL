    ...
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://t.me/teflasius">
          <h2 class="name">Qbittorrent Selection</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://www.github.com/Beyllins/panda-dl"><i class="fab fa-github"></i></a>
        <a href="https://t.me/teflasius"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <div id="sticks">
...
@app.route('/')
def homepage():
    return "<h1>See mirror-leech-telegram-bot <a href='https://www.github.com/Beyllins/panda-dl'>@GitHub</a> By <a href='https://github.com/beyllins'>Beyllins</a></h1>"
